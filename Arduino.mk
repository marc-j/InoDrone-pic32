...
LOCAL_PDE_SRCS  += $(wildcard src/*.$(SUFFIX))
...
USER_LIBS     = $(patsubst %,$(USER_LIB_PATH)/%,$(USER_LIBS_SEL))
...
$(OBJDIR)/libs/%.o: $(USER_LIB_PATH)/%.cpp
	mkdir -p $(dir $@)
#	$(CXX) -c $(CPPFLAGS_WITHOUT_USER_LIBS) -I$(dir $<) -I$(dir $<)/.. $(CFLAGS) $< -o $@
	$(CXX) -c $(CPPFLAGS) $(CFLAGS) $< -o $@
$(OBJDIR)/libs/%.o: $(USER_LIB_PATH)/%.c
	mkdir -p $(dir $@)
#	$(CC) -c $(CPPFLAGS_WITHOUT_USER_LIBS) -I$(dir $<) -I$(dir $<)/.. $(CFLAGS) $< -o $@
	$(CC) -c $(CPPFLAGS) $(CFLAGS) $< -o $@
